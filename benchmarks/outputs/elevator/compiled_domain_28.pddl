...
(:predicates
  ...
  (AUX9 ?y2 - object ?y1 - object ?y3 - object ?y0 - object)
  ...
  (AUX27 ?y0 - object)
  (AUX28 ?x1 - object ?y1 - object ?y0 - object ?x0 - object)
...
(:derived (incompatible_update)
          (exists (?y0 ?y1 ?y2 ?y3 - object) (AUX9 ?y2 ?y1 ?y3 ?y0)))
(:derived (ins_passenger_closure ?x0 - object)
...
(:derived (del_next ?x0 ?x1 - object)
          (exists (?y0 ?y1 - object) (AUX28 ?x1 ?y1 ?y0 ?x0)))
(:derived (ins_passenger_closure ?x0 - object)
...
(:derived (AUX9 ?y2 - object ?y1 - object ?y3 - object ?y0 - object)
...
(:derived (AUX28 ?x1 - object ?y1 - object ?y0 - object ?x0 - object)
