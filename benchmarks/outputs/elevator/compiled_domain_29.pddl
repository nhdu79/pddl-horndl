...
(:predicates
  ...
  (AUX23 ?x0 - object ?x1 - object ?y0 - object ?y1 - object)
  (AUX24 ?y0 - object)
  ...
  (AUX30 ?y0 - object)
  (AUX31 ?y0 - object)
  (AUX32 ?y2 - object ?y3 - object ?y0 - object ?y1 - object)
...
(:derived (del_next ?x0 ?x1 - object)
          (exists (?y0 ?y1 - object) (AUX23 ?x0 ?x1 ?y0 ?y1)))
(:derived (del_origin ?x0 ?x1 - object)
...
(:derived (incompatible_update)
          (exists (?y0 ?y1 ?y2 ?y3 - object) (AUX32 ?y2 ?y3 ?y0 ?y1)))
(:derived (incompatible_update)
...
(:derived (AUX23 ?x0 - object ?x1 - object ?y0 - object ?y1 - object)
...
(:derived (AUX32 ?y2 - object ?y3 - object ?y0 - object ?y1 - object)
