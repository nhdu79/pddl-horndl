...
(:predicates
  ...
  (AUX24 ?y2 - object ?y3 - object ?y1 - object ?y0 - object)
  (AUX25 ?y0 - object)
  (AUX26 ?y0 - object)
  ...
  (AUX31 ?x0 - object ?x1 - object ?y1 - object ?y0 - object)
...
(:derived (incompatible_update)
          (exists (?y0 ?y1 ?y2 ?y3 - object) (AUX24 ?y2 ?y3 ?y1 ?y0)))
(:derived (del_destin ?x0 ?x1 - object)
...
(:derived (del_next ?x0 ?x1 - object)
          (exists (?y0 ?y1 - object) (AUX31 ?x0 ?x1 ?y1 ?y0)))
(:derived (incompatible_update)
...
(:derived (AUX24 ?y2 - object ?y3 - object ?y1 - object ?y0 - object)
...
(:derived (AUX31 ?x0 - object ?x1 - object ?y1 - object ?y0 - object)
