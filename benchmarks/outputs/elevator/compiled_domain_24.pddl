...
(:predicates
  ...
  (AUX14 ?y0 - object)
  (AUX15 ?y0 - object)
  (AUX16 ?x1 - object ?y0 - object ?x0 - object ?y1 - object)
  ...
  (AUX29 ?y0 - object)
  (AUX30 ?y0 - object)
  (AUX31 ?y3 - object ?y2 - object ?y0 - object ?y1 - object)
...
(:derived (del_next ?x0 ?x1 - object)
          (exists (?y0 ?y1 - object) (AUX16 ?x1 ?y0 ?x0 ?y1)))
(:derived (ins_next ?x0 ?x1 - object)
...
(:derived (incompatible_update)
          (exists (?y0 ?y1 ?y2 ?y3 - object) (AUX31 ?y3 ?y2 ?y0 ?y1)))
(:derived (ins_floor_closure ?x0 - object)
...
(:derived (AUX16 ?x1 - object ?y0 - object ?x0 - object ?y1 - object)
...
(:derived (AUX31 ?y3 - object ?y2 - object ?y0 - object ?y1 - object)
