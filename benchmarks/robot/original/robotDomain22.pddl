(define (domain robot)
	...
	(:action moveRight
		...
		:effect (and 
			...
			(when (and (mko (LeftOf2 ?x)) (not (mko (LeftOf3 ?x))))
				(and (not (LeftOf2 ?x)))
				)
			(when (mko (LeftOf3 ?x))
				(and (LeftOf4 ?x))
				)
			(when (and (mko (LeftOf3 ?x)) (not (mko (LeftOf4 ?x))))
				(and (not (LeftOf3 ?x)))
				)
			(when (mko (LeftOf4 ?x))
				(and (LeftOf5 ?x))
				)
			(when (and (mko (LeftOf4 ?x)) (not (mko (LeftOf5 ?x))))
				(and (not (LeftOf4 ?x)))
				)
			(when (mko (LeftOf5 ?x))
				(and (LeftOf6 ?x))
				)
			(when (and (mko (LeftOf5 ?x)) (not (mko (LeftOf6 ?x))))
				(and (not (LeftOf5 ?x)))
				)
			(when (mko (LeftOf6 ?x))
				(and (LeftOf7 ?x))
				)
			(when (and (mko (LeftOf6 ?x)) (not (mko (LeftOf7 ?x))))
				(and (not (LeftOf6 ?x)))
				)
			(when (mko (LeftOf7 ?x))
				(and (LeftOf8 ?x))
				)
			(when (and (mko (LeftOf7 ?x)) (not (mko (LeftOf8 ?x))))
				(and (not (LeftOf7 ?x)))
				)
			(when (mko (LeftOf8 ?x))
				(and (LeftOf9 ?x))
				)
			(when (and (mko (LeftOf8 ?x)) (not (mko (LeftOf9 ?x))))
				(and (not (LeftOf8 ?x)))
				)
			(when (mko (LeftOf9 ?x))
				(and (LeftOf10 ?x))
				)
			(when (and (mko (LeftOf9 ?x)) (not (mko (LeftOf10 ?x))))
				(and (not (LeftOf9 ?x)))
				)
			(when (mko (LeftOf10 ?x))
				(and (LeftOf11 ?x))
				)
			(when (and (mko (LeftOf10 ?x)) (not (mko (LeftOf11 ?x))))
				(and (not (LeftOf10 ?x)))
				)
			(when (mko (LeftOf11 ?x))
				(and (LeftOf12 ?x))
				)
			(when (and (mko (LeftOf11 ?x)) (not (mko (LeftOf12 ?x))))
				(and (not (LeftOf11 ?x)))
				)
			(when (mko (LeftOf12 ?x))
				(and (LeftOf13 ?x))
				)
			(when (and (mko (LeftOf12 ?x)) (not (mko (LeftOf13 ?x))))
				(and (not (LeftOf12 ?x)))
				)
			(when (mko (LeftOf13 ?x))
				(and (LeftOf14 ?x))
				)
			(when (and (mko (LeftOf13 ?x)) (not (mko (LeftOf14 ?x))))
				(and (not (LeftOf13 ?x)))
				)
			(when (mko (LeftOf14 ?x))
				(and (LeftOf15 ?x))
				)
			(when (and (mko (LeftOf14 ?x)) (not (mko (LeftOf15 ?x))))
				(and (not (LeftOf14 ?x)))
				)
			(when (mko (LeftOf15 ?x))
				(and (LeftOf16 ?x))
				)
			(when (and (mko (LeftOf15 ?x)) (not (mko (LeftOf16 ?x))))
				(and (not (LeftOf15 ?x)))
				)
			(when (mko (LeftOf16 ?x))
				(and (LeftOf17 ?x))
				)
			(when (and (mko (LeftOf16 ?x)) (not (mko (LeftOf17 ?x))))
				(and (not (LeftOf16 ?x)))
				)
			(when (mko (LeftOf17 ?x))
				(and (LeftOf18 ?x))
				)
			(when (and (mko (LeftOf17 ?x)) (not (mko (LeftOf18 ?x))))
				(and (not (LeftOf17 ?x)))
				)
			(when (mko (LeftOf18 ?x))
				(and (LeftOf19 ?x))
				)
			(when (and (mko (LeftOf18 ?x)) (not (mko (LeftOf19 ?x))))
				(and (not (LeftOf18 ?x)))
				)
			(when (mko (LeftOf19 ?x))
				(and (LeftOf20 ?x))
				)
			(when (and (mko (LeftOf19 ?x)) (not (mko (LeftOf20 ?x))))
				(and (not (LeftOf19 ?x)))
				)
			(when (mko (LeftOf20 ?x))
				(and (LeftOf21 ?x))
				)
			(when (and (mko (LeftOf20 ?x)) (not (mko (LeftOf21 ?x))))
				(and (not (LeftOf20 ?x)))
				)
			(when (mko (LeftOf21 ?x))
				(and (LeftOf22 ?x))
				)
			(when (and (mko (LeftOf21 ?x)) (not (mko (LeftOf22 ?x))))
				(and (not (LeftOf21 ?x)))
				)
			(when (mko (Column0 ?x))
				(and (Column1 ?x)
	...
	(:action moveUp
		...
		:effect (and 
			...
			(when (and (mko (BelowOf2 ?x)) (not (mko (BelowOf3 ?x))))
				(and (not (BelowOf2 ?x)))
				)
			(when (mko (BelowOf3 ?x))
				(and (BelowOf4 ?x))
				)
			(when (and (mko (BelowOf3 ?x)) (not (mko (BelowOf4 ?x))))
				(and (not (BelowOf3 ?x)))
				)
			(when (mko (BelowOf4 ?x))
				(and (BelowOf5 ?x))
				)
			(when (and (mko (BelowOf4 ?x)) (not (mko (BelowOf5 ?x))))
				(and (not (BelowOf4 ?x)))
				)
			(when (mko (BelowOf5 ?x))
				(and (BelowOf6 ?x))
				)
			(when (and (mko (BelowOf5 ?x)) (not (mko (BelowOf6 ?x))))
				(and (not (BelowOf5 ?x)))
				)
			(when (mko (BelowOf6 ?x))
				(and (BelowOf7 ?x))
				)
			(when (and (mko (BelowOf6 ?x)) (not (mko (BelowOf7 ?x))))
				(and (not (BelowOf6 ?x)))
				)
			(when (mko (BelowOf7 ?x))
				(and (BelowOf8 ?x))
				)
			(when (and (mko (BelowOf7 ?x)) (not (mko (BelowOf8 ?x))))
				(and (not (BelowOf7 ?x)))
				)
			(when (mko (BelowOf8 ?x))
				(and (BelowOf9 ?x))
				)
			(when (and (mko (BelowOf8 ?x)) (not (mko (BelowOf9 ?x))))
				(and (not (BelowOf8 ?x)))
				)
			(when (mko (BelowOf9 ?x))
				(and (BelowOf10 ?x))
				)
			(when (and (mko (BelowOf9 ?x)) (not (mko (BelowOf10 ?x))))
				(and (not (BelowOf9 ?x)))
				)
			(when (mko (BelowOf10 ?x))
				(and (BelowOf11 ?x))
				)
			(when (and (mko (BelowOf10 ?x)) (not (mko (BelowOf11 ?x))))
				(and (not (BelowOf10 ?x)))
				)
			(when (mko (BelowOf11 ?x))
				(and (BelowOf12 ?x))
				)
			(when (and (mko (BelowOf11 ?x)) (not (mko (BelowOf12 ?x))))
				(and (not (BelowOf11 ?x)))
				)
			(when (mko (BelowOf12 ?x))
				(and (BelowOf13 ?x))
				)
			(when (and (mko (BelowOf12 ?x)) (not (mko (BelowOf13 ?x))))
				(and (not (BelowOf12 ?x)))
				)
			(when (mko (BelowOf13 ?x))
				(and (BelowOf14 ?x))
				)
			(when (and (mko (BelowOf13 ?x)) (not (mko (BelowOf14 ?x))))
				(and (not (BelowOf13 ?x)))
				)
			(when (mko (BelowOf14 ?x))
				(and (BelowOf15 ?x))
				)
			(when (and (mko (BelowOf14 ?x)) (not (mko (BelowOf15 ?x))))
				(and (not (BelowOf14 ?x)))
				)
			(when (mko (BelowOf15 ?x))
				(and (BelowOf16 ?x))
				)
			(when (and (mko (BelowOf15 ?x)) (not (mko (BelowOf16 ?x))))
				(and (not (BelowOf15 ?x)))
				)
			(when (mko (BelowOf16 ?x))
				(and (BelowOf17 ?x))
				)
			(when (and (mko (BelowOf16 ?x)) (not (mko (BelowOf17 ?x))))
				(and (not (BelowOf16 ?x)))
				)
			(when (mko (BelowOf17 ?x))
				(and (BelowOf18 ?x))
				)
			(when (and (mko (BelowOf17 ?x)) (not (mko (BelowOf18 ?x))))
				(and (not (BelowOf17 ?x)))
				)
			(when (mko (BelowOf18 ?x))
				(and (BelowOf19 ?x))
				)
			(when (and (mko (BelowOf18 ?x)) (not (mko (BelowOf19 ?x))))
				(and (not (BelowOf18 ?x)))
				)
			(when (mko (BelowOf19 ?x))
				(and (BelowOf20 ?x))
				)
			(when (and (mko (BelowOf19 ?x)) (not (mko (BelowOf20 ?x))))
				(and (not (BelowOf19 ?x)))
				)
			(when (mko (BelowOf20 ?x))
				(and (BelowOf21 ?x))
				)
			(when (and (mko (BelowOf20 ?x)) (not (mko (BelowOf21 ?x))))
				(and (not (BelowOf20 ?x)))
				)
			(when (mko (BelowOf21 ?x))
				(and (BelowOf22 ?x))
				)
			(when (and (mko (BelowOf21 ?x)) (not (mko (BelowOf22 ?x))))
				(and (not (BelowOf21 ?x)))
				)
			(when (mko (Row0 ?x))
				(and (Row1 ?x)
