...
(:predicates
  ...
  (AUX28 ?y1 - object ?y0 - object ?x0 - object ?x1 - object)
...
(:derived (compatible_update)
          (forall (?Y1 ?Y0 ?Y3 ?Y2 - object) (and (AUX0 ?Y0) (AUX1 ?Y0 ?Y1) (AUX2 ?Y0 ?Y1) (AUX3 ?Y0) (AUX4 ?Y0) (AUX5 ?Y0 ?Y1) (AUX6 ?Y0) (AUX7 ?Y0 ?Y1) (AUX8 ?Y0 ?Y1) (AUX9 ?Y0) (AUX10 ?Y0 ?Y1) (AUX11 ?Y0 ?Y1) (AUX12 ?Y0) (AUX13 ?Y0) (AUX14 ?Y0) (AUX15 ?Y0) (AUX16 ?Y0) (AUX17 ?Y0 ?Y1) (AUX18 ?Y0 ?Y1) (AUX19 ?Y0 ?Y1) (AUX20 ?Y0) (AUX21 ?Y0) (AUX22 ?Y0 ?Y1) (AUX23 ?Y0) (AUX24 ?Y0) (AUX25 ?Y2 ?Y0 ?Y1 ?Y3))))
...
(:derived (del_next ?x0 ?x1 - object)
          (exists (?y0 ?y1 - object) (AUX28 ?y1 ?y0 ?x0 ?x1)))
...
(:derived (AUX28 ?y1 - object ?y0 - object ?x0 - object ?x1 - object)
