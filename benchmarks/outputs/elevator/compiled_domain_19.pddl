...
(:predicates
  ...
  (AUX16 ?y0 - object)
  (AUX17 ?x0 - object ?y0 - object ?y1 - object ?x1 - object)
  ...
  (AUX32 ?y1 - object ?y0 - object ?y3 - object ?y2 - object)
...
(:derived (del_next ?x0 ?x1 - object)
          (exists (?y0 ?y1 - object) (AUX17 ?x0 ?y0 ?y1 ?x1)))
(:derived (incompatible_update)
...
(:derived (incompatible_update)
          (exists (?y0 ?y1 ?y2 ?y3 - object) (AUX32 ?y1 ?y0 ?y3 ?y2)))
(:derived (updating)
...
(:derived (AUX17 ?x0 - object ?y0 - object ?y1 - object ?x1 - object)
...
(:derived (AUX32 ?y1 - object ?y0 - object ?y3 - object ?y2 - object)
