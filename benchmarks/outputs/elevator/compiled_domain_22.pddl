...
(:predicates
  ...
  (AUX79 ?y0 - object ?y1 - object ?f1 - object ?f2 - object)
...
(:derived (ins_passenger_closure ?p - object)
          (or (exists (?y0 - object) (AUX31 ?p ?y0)) (exists (?y0 - object) (AUX32 ?p ?y0)) (AUX30 ?p) (AUX33 ?p)))
...
(:derived (del_floor ?p - object)
          (or (exists (?y0 - object) (AUX52 ?p ?y0)) (exists (?y0 - object) (AUX53 ?p ?y0)) (AUX48 ?p) (AUX49 ?p) (AUX50 ?p) (AUX51 ?p)))
(:derived (ins_floor_closure ?p - object)
          (or (exists (?y0 - object) (AUX54 ?p ?y0)) (exists (?y0 - object) (AUX56 ?p ?y0)) (AUX55 ?p)))
...
(:derived (del_liftat ?f - object)
          (or (exists (?y0 - object) (AUX74 ?f ?y0)) (exists (?y0 - object) (AUX75 ?f ?y0)) (AUX71 ?f) (AUX72 ?f) (AUX73 ?f) (AUX76 ?f) (AUX77 ?f)))
(:derived (ins_next ?f1 ?f2 - object)
          (or (AUX78 ?f1 ?f2) (ins_next_closure ?f1 ?f2)))
(:derived (del_next ?f1 ?f2 - object)
          (or (exists (?y0 ?y1 - object) (AUX79 ?y0 ?y1 ?f1 ?f2)) (AUX80 ?f1 ?f2)))
...
(:derived (AUX79 ?y0 - object ?y1 - object ?f1 - object ?f2 - object)
