...
(:predicates
  ...
  (AUX10 ?x0 - object ?y1 - object ?x1 - object ?y0 - object)
...
(:derived (del_next ?x0 ?x1 - object)
          (exists (?y0 ?y1 - object) (AUX10 ?x0 ?y1 ?x1 ?y0)))
(:derived (updating)
...
(:derived (incompatible_update)
          (exists (?y0 ?y1 ?y2 ?y3 - object) (AUX19 ?y3 ?y1 ?y2 ?y0)))
...
(:derived (AUX10 ?x0 - object ?y1 - object ?x1 - object ?y0 - object)
