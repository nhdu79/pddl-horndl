...
(:predicates
  ...
  (AUX19 ?y1 - object ?y0 - object ?y3 - object ?y2 - object)
  (AUX20 ?y0 - object)
  (AUX21 ?x0 - object ?y0 - object)
  (AUX22 ?x0 - object ?y0 - object ?y1 - object ?x1 - object)
  (AUX23 ?y0 - object)
...
(:derived (incompatible_update)
          (exists (?y0 ?y1 ?y2 ?y3 - object) (AUX19 ?y1 ?y0 ?y3 ?y2)))
...
(:derived (del_next ?x0 ?x1 - object)
          (exists (?y0 ?y1 - object) (AUX22 ?x0 ?y0 ?y1 ?x1)))
(:derived (ins_boarded ?x0 - object)
...
(:derived (AUX19 ?y1 - object ?y0 - object ?y3 - object ?y2 - object)
...
(:derived (AUX22 ?x0 - object ?y0 - object ?y1 - object ?x1 - object)
