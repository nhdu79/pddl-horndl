...
(:derived (del_next ?x0 ?x1 - object)
          (exists (?y0 ?y1 - object) (AUX11 ?y1 ?y0 ?x0 ?x1)))
(:derived (incompatible_update)
...
(:derived (incompatible_update)
          (exists (?y0 ?y1 ?y2 ?y3 - object) (AUX17 ?y1 ?y0 ?y3 ?y2)))
...
(:derived (AUX11 ?y1 - object ?y0 - object ?x0 - object ?x1 - object)
...
(:derived (AUX17 ?y1 - object ?y0 - object ?y3 - object ?y2 - object)
