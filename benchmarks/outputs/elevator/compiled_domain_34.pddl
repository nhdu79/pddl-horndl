...
(:predicates
  ...
  (AUX16 ?y0 - object)
  (AUX17 ?y0 - object)
  (AUX18 ?y2 - object ?y0 - object ?y3 - object ?y1 - object)
  (AUX19 ?y0 - object)
  (AUX20 ?y0 - object)
  ...
  (AUX28 ?x1 - object ?y0 - object ?x0 - object ?y1 - object)
...
(:derived (incompatible_update)
          (exists (?y0 ?y1 ?y2 ?y3 - object) (AUX18 ?y2 ?y0 ?y3 ?y1)))
(:derived (incompatible_update)
...
(:derived (del_next ?x0 ?x1 - object)
          (exists (?y0 ?y1 - object) (AUX28 ?x1 ?y0 ?x0 ?y1)))
(:derived (updating)
...
(:derived (AUX18 ?y2 - object ?y0 - object ?y3 - object ?y1 - object)
...
(:derived (AUX28 ?x1 - object ?y0 - object ?x0 - object ?y1 - object)
