...
(:predicates
  ...
  (AUX19 ?y0 - object ?y1 - object ?y3 - object ?y2 - object)
  (AUX20 ?y0 - object)
  ...
  (AUX34 ?y0 - object ?y1 - object ?x0 - object ?x1 - object)
  (AUX35 ?x - object))
...
(:derived (incompatible_update)
          (exists (?y0 ?y1 ?y2 ?y3 - object) (AUX19 ?y0 ?y1 ?y3 ?y2)))
(:derived (del_served ?x0 - object)
...
(:derived (del_next ?x0 ?x1 - object)
          (exists (?y0 ?y1 - object) (AUX34 ?y0 ?y1 ?x0 ?x1)))
(:derived (ins_served ?x0 - object)
...
(:derived (AUX19 ?y0 - object ?y1 - object ?y3 - object ?y2 - object)
...
(:derived (AUX34 ?y0 - object ?y1 - object ?x0 - object ?x1 - object)
