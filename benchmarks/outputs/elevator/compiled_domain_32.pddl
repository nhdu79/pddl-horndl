...
(:predicates
  ...
  (AUX25 ?y1 - object ?x0 - object ?y0 - object ?x1 - object)
  (AUX26 ?y0 - object)
  (AUX27 ?y0 - object)
...
(:derived (incompatible_update)
          (exists (?y0 ?y1 ?y2 ?y3 - object) (AUX12 ?y0 ?y3 ?y1 ?y2)))
(:derived (ins_floor ?x0 - object)
...
(:derived (del_next ?x0 ?x1 - object)
          (exists (?y0 ?y1 - object) (AUX25 ?y1 ?x0 ?y0 ?x1)))
(:derived (updating)
...
(:derived (AUX25 ?y1 - object ?x0 - object ?y0 - object ?x1 - object)
