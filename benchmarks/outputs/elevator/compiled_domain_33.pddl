...
(:predicates
  ...
  (AUX1 ?y1 - object ?y0 - object ?x0 - object ?x1 - object)
  (AUX2 ?y0 - object)
  ...
  (AUX24 ?y0 - object)
  (AUX25 ?y0 - object)
  (AUX26 ?y1 - object ?y2 - object ?y0 - object ?y3 - object)
...
(:derived (del_next ?x0 ?x1 - object)
          (exists (?y0 ?y1 - object) (AUX1 ?y1 ?y0 ?x0 ?x1)))
...
(:derived (incompatible_update)
          (exists (?y0 ?y1 ?y2 ?y3 - object) (AUX26 ?y1 ?y2 ?y0 ?y3)))
(:derived (del_passenger ?x0 - object)
...
(:derived (AUX1 ?y1 - object ?y0 - object ?x0 - object ?x1 - object)
...
(:derived (AUX26 ?y1 - object ?y2 - object ?y0 - object ?y3 - object)
