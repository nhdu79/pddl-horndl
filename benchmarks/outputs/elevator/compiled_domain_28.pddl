...
(:predicates
  ...
  (AUX10 ?y1 - object ?y3 - object ?y2 - object ?y0 - object)
  ...
  (AUX28 ?y0 - object)
  (AUX29 ?x0 - object ?y1 - object ?x1 - object ?y0 - object)
...
(:derived (incompatible_update)
          (exists (?y0 ?y1 ?y2 ?y3 - object) (AUX10 ?y1 ?y3 ?y2 ?y0)))
(:derived (del_liftat ?x0 - object)
...
(:derived (del_next ?x0 ?x1 - object)
          (exists (?y0 ?y1 - object) (AUX29 ?x0 ?y1 ?x1 ?y0)))
(:derived (del_boarded ?x0 - object)
...
(:derived (AUX10 ?y1 - object ?y3 - object ?y2 - object ?y0 - object)
...
(:derived (AUX29 ?x0 - object ?y1 - object ?x1 - object ?y0 - object)
