...
(:predicates
  ...
  (AUX12 ?x0 - object ?y0 - object ?y1 - object ?x1 - object)
...
(:derived (incompatible_update)
          (exists (?y0 ?y1 ?y2 ?y3 - object) (AUX3 ?y2 ?y0 ?y3 ?y1)))
(:derived (del_boarded ?x0 - object)
...
(:derived (del_next ?x0 ?x1 - object)
          (exists (?y0 ?y1 - object) (AUX12 ?x0 ?y0 ?y1 ?x1)))
(:derived (updating)
...
(:derived (AUX12 ?x0 - object ?y0 - object ?y1 - object ?x1 - object)
