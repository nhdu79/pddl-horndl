...
(:predicates
  ...
  (AUX24 ?y1 - object ?y2 - object ?y0 - object ?y3 - object)
  ...
  (AUX33 ?x0 - object ?y1 - object ?x1 - object ?y0 - object)
...
(:derived (incompatible_update)
          (exists (?y0 ?y1 ?y2 ?y3 - object) (AUX24 ?y1 ?y2 ?y0 ?y3)))
(:derived (incompatible_update)
...
(:derived (del_next ?x0 ?x1 - object)
          (exists (?y0 ?y1 - object) (AUX33 ?x0 ?y1 ?x1 ?y0)))
(:derived (ins_floor_closure ?x0 - object)
...
(:derived (AUX24 ?y1 - object ?y2 - object ?y0 - object ?y3 - object)
...
(:derived (AUX33 ?x0 - object ?y1 - object ?x1 - object ?y0 - object)
