...
(:predicates
  ...
  (AUX0 ?y0 - object)
  (AUX1 ?y1 - object ?x1 - object ?y0 - object ?x0 - object)
  ...
  (AUX14 ?y3 - object ?y1 - object ?y0 - object ?y2 - object)
  (AUX15 ?y0 - object)
  (AUX16 ?y0 - object)
...
(:derived (del_next ?x0 ?x1 - object)
          (exists (?y0 ?y1 - object) (AUX1 ?y1 ?x1 ?y0 ?x0)))
(:derived (incompatible_update)
...
(:derived (incompatible_update)
          (exists (?y0 ?y1 ?y2 ?y3 - object) (AUX14 ?y3 ?y1 ?y0 ?y2)))
(:derived (del_destin ?x0 ?x1 - object)
...
(:derived (AUX1 ?y1 - object ?x1 - object ?y0 - object ?x0 - object)
...
(:derived (AUX14 ?y3 - object ?y1 - object ?y0 - object ?y2 - object)
