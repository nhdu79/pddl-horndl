...
(:predicates
  ...
  (AUX30 ?y0 - object ?y1 - object ?x1 - object ?x0 - object)
...
(:derived (compatible_update)
          (forall (?Y3 ?Y0 ?Y1 ?Y2 - object) (and (AUX0 ?Y0) (AUX1 ?Y1 ?Y0) (AUX2 ?Y1 ?Y0) (AUX3 ?Y0) (AUX4 ?Y0) (AUX5 ?Y1 ?Y0) (AUX6 ?Y0) (AUX7 ?Y1 ?Y0) (AUX8 ?Y1 ?Y0) (AUX9 ?Y0) (AUX10 ?Y1 ?Y0) (AUX11 ?Y1 ?Y0) (AUX12 ?Y0) (AUX13 ?Y0) (AUX14 ?Y0) (AUX15 ?Y0) (AUX16 ?Y0) (AUX17 ?Y1 ?Y0) (AUX18 ?Y1 ?Y0) (AUX19 ?Y1 ?Y0) (AUX20 ?Y0) (AUX21 ?Y0) (AUX22 ?Y1 ?Y0) (AUX23 ?Y0) (AUX24 ?Y0) (AUX25 ?Y3 ?Y0 ?Y2 ?Y1))))
...
(:derived (del_next ?x0 ?x1 - object)
          (exists (?y0 ?y1 - object) (AUX30 ?y0 ?y1 ?x1 ?x0)))
...
(:derived (AUX30 ?y0 - object ?y1 - object ?x1 - object ?x0 - object)
