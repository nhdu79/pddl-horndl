...
(:predicates
  ...
  (AUX16 ?y0 - object)
  (AUX17 ?x0 - object ?x1 - object ?y1 - object ?y0 - object)
...
(:derived (incompatible_update)
          (exists (?y0 ?y1 ?y2 ?y3 - object) (AUX9 ?y1 ?y2 ?y3 ?y0)))
(:derived (updating)
...
(:derived (del_next ?x0 ?x1 - object)
          (exists (?y0 ?y1 - object) (AUX17 ?x0 ?x1 ?y1 ?y0)))
...
(:derived (AUX17 ?x0 - object ?x1 - object ?y1 - object ?y0 - object)
