...
(:predicates
  ...
  (AUX0 ?y0 - object)
  (AUX1 ?x1 - object ?y0 - object ?x0 - object ?y1 - object)
...
(:derived (del_next ?x0 ?x1 - object)
          (exists (?y0 ?y1 - object) (AUX1 ?x1 ?y0 ?x0 ?y1)))
(:derived (updating)
...
(:derived (incompatible_update)
          (exists (?y0 ?y1 ?y2 ?y3 - object) (AUX9 ?y2 ?y0 ?y3 ?y1)))
(:derived (del_served ?x0 - object)
...
(:derived (AUX1 ?x1 - object ?y0 - object ?x0 - object ?y1 - object)
