...
(:predicates
  ...
  (AUX13 ?y0 - object)
  (AUX14 ?y0 - object)
  (AUX15 ?y2 - object ?y1 - object ?y3 - object ?y0 - object)
  (AUX16 ?y1 - object ?y0 - object)
  (AUX17 ?x0 - object ?y1 - object ?x1 - object ?y0 - object)
  (AUX18 ?y0 - object)
...
(:derived (incompatible_update)
          (exists (?y0 ?y1 ?y2 ?y3 - object) (AUX15 ?y2 ?y1 ?y3 ?y0)))
(:derived (incompatible_update)
...
(:derived (del_next ?x0 ?x1 - object)
          (exists (?y0 ?y1 - object) (AUX17 ?x0 ?y1 ?x1 ?y0)))
(:derived (incompatible_update)
...
(:derived (AUX15 ?y2 - object ?y1 - object ?y3 - object ?y0 - object)
...
(:derived (AUX17 ?x0 - object ?y1 - object ?x1 - object ?y0 - object)
