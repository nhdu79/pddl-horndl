...
(:predicates
  ...
  (AUX9 ?y1 - object ?y2 - object ?y0 - object ?y3 - object)
  (AUX10 ?y0 - object ?y1 - object)
  (AUX11 ?y1 - object ?x1 - object ?x0 - object ?y0 - object)
...
(:derived (DATALOG_PASSENGER ?x0 - object)
          (boarded ?x0))
(:derived (incompatible_update)
          (exists (?y0 ?y1 ?y2 ?y3 - object) (AUX9 ?y1 ?y2 ?y0 ?y3)))
(:derived (updating)
...
(:derived (del_next ?x0 ?x1 - object)
          (exists (?y0 ?y1 - object) (AUX11 ?y1 ?x1 ?x0 ?y0)))
(:derived (incompatible_update)
...
(:derived (AUX9 ?y1 - object ?y2 - object ?y0 - object ?y3 - object)
...
(:derived (AUX11 ?y1 - object ?x1 - object ?x0 - object ?y0 - object)
