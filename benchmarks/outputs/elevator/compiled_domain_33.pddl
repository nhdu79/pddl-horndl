...
(:predicates
  ...
  (AUX1 ?x1 - object ?x0 - object ?y0 - object ?y1 - object)
  (AUX2 ?y0 - object)
...
(:derived (del_next ?x0 ?x1 - object)
          (exists (?y0 ?y1 - object) (AUX1 ?x1 ?x0 ?y0 ?y1)))
...
(:derived (incompatible_update)
          (exists (?y0 ?y1 ?y2 ?y3 - object) (AUX12 ?y0 ?y1 ?y2 ?y3)))
...
(:derived (AUX1 ?x1 - object ?x0 - object ?y0 - object ?y1 - object)
