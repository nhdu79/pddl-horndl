...
(:predicates
  ...
  (AUX21 ?y1 - object ?x0 - object ?x1 - object ?y0 - object)
  (AUX22 ?y0 - object)
  ...
  (AUX27 ?y0 - object)
  (AUX28 ?y3 - object ?y1 - object ?y2 - object ?y0 - object)
  (AUX29 ?y0 - object)
...
(:derived (del_next ?x0 ?x1 - object)
          (exists (?y0 ?y1 - object) (AUX21 ?y1 ?x0 ?x1 ?y0)))
(:derived (del_liftat ?x0 - object)
...
(:derived (incompatible_update)
          (exists (?y0 ?y1 ?y2 ?y3 - object) (AUX28 ?y3 ?y1 ?y2 ?y0)))
(:derived (updating)
...
(:derived (AUX21 ?y1 - object ?x0 - object ?x1 - object ?y0 - object)
...
(:derived (AUX28 ?y3 - object ?y1 - object ?y2 - object ?y0 - object)
