...
(:predicates
  ...
  (AUX28 ?x0 - object ?y0 - object ?x1 - object ?y1 - object)
  (AUX29 ?y0 - object ?y3 - object ?y2 - object ?y1 - object)
  (AUX30 ?y0 - object)
...
(:derived (DATALOG_PASSENGER ?x0 - object)
          (served ?x0))
(:derived (del_next ?x0 ?x1 - object)
          (exists (?y0 ?y1 - object) (AUX28 ?x0 ?y0 ?x1 ?y1)))
(:derived (updating)
...
(:derived (incompatible_update)
          (exists (?y0 ?y1 ?y2 ?y3 - object) (AUX29 ?y0 ?y3 ?y2 ?y1)))
(:derived (ins_passenger_closure ?x0 - object)
...
(:derived (AUX28 ?x0 - object ?y0 - object ?x1 - object ?y1 - object)
          (and (ins_next_request ?x0 ?y0) (next ?x0 ?x1) (not (= ?x1 ?y1))))
(:derived (AUX29 ?y0 - object ?y3 - object ?y2 - object ?y1 - object)
