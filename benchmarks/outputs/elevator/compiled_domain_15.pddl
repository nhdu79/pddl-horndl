...
(:predicates
  ...
  (AUX11 ?y0 - object)
  (AUX12 ?y1 - object ?y0 - object ?x0 - object ?x1 - object)
  (AUX13 ?y0 - object)
  (AUX14 ?y1 - object ?y0 - object ?y3 - object ?y2 - object)
...
(:derived (del_next ?x0 ?x1 - object)
          (exists (?y0 ?y1 - object) (AUX12 ?y1 ?y0 ?x0 ?x1)))
...
(:derived (incompatible_update)
          (exists (?y0 ?y1 ?y2 ?y3 - object) (AUX14 ?y1 ?y0 ?y3 ?y2)))
(:derived (ins_passenger_closure ?x0 - object)
