...
(:predicates
  ...
  (AUX0 ?y0 - object)
  (AUX1 ?y1 - object ?x1 - object ?x0 - object ?y0 - object)
  ...
  (AUX13 ?y0 - object)
  (AUX14 ?y1 - object ?y2 - object ?y3 - object ?y0 - object)
  (AUX15 ?y0 - object)
  (AUX16 ?y0 - object)
...
(:derived (del_next ?x0 ?x1 - object)
          (exists (?y0 ?y1 - object) (AUX1 ?y1 ?x1 ?x0 ?y0)))
(:derived (ins_next ?x0 ?x1 - object)
...
(:derived (incompatible_update)
          (exists (?y0 ?y1 ?y2 ?y3 - object) (AUX14 ?y1 ?y2 ?y3 ?y0)))
(:derived (incompatible_update)
...
(:derived (AUX1 ?y1 - object ?x1 - object ?x0 - object ?y0 - object)
...
(:derived (AUX14 ?y1 - object ?y2 - object ?y3 - object ?y0 - object)
