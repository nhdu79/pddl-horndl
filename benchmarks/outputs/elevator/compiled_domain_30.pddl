...
(:predicates
  ...
  (AUX4 ?y0 - object)
  (AUX5 ?y0 - object)
  (AUX6 ?y0 - object ?y1 - object ?x0 - object ?x1 - object)
...
(:derived (del_next ?x0 ?x1 - object)
          (exists (?y0 ?y1 - object) (AUX6 ?y0 ?y1 ?x0 ?x1)))
(:derived (del_boarded ?x0 - object)
          (and (boarded ?x0) (del_boarded_request ?x0)))
(:derived (incompatible_update)
          (exists (?y0 ?y1 ?y2 ?y3 - object) (AUX7 ?y0 ?y2 ?y1 ?y3)))
...
(:derived (AUX6 ?y0 - object ?y1 - object ?x0 - object ?x1 - object)
